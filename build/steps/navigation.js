...
__decorate([index_1.then(/^should be a transition to (.*)$/), index_1.then(/^должен произойти переход (?:на|в) (.*)$/), __metadata('design:type', Function), __metadata('design:paramtypes', [String]), __metadata('design:returntype', Promise)], Navigation.prototype, "urlShouldBe", null);
